    ...
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-md dark:shadow-2xl space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 dark:border-slate-800/80 pb-5">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-2xl bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 shadow-inner">
        ...
        <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-950 px-3 py-1.5 rounded-xl border border-slate-200 dark:border-slate-800 text-xs font-mono text-slate-700 dark:text-slate-300">
          <span>{language === 'es' ? 'Moneda:' : 'Currency:'}</span>
          <strong className="text-emerald-600 dark:text-emerald-400 font-bold">{auction.currency}</strong>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-6 space-y-5">
          ...
          <div className="space-y-2 bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-200 dark:border-slate-800/80">
            ...
            <div className="divide-y divide-slate-200 dark:divide-slate-800/80 text-xs space-y-1.5 pt-1">
              <div className="flex justify-between items-center pt-1.5 text-slate-500 dark:text-slate-400">
        ...
        <div className="lg:col-span-6 space-y-5">
          <div className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-md dark:shadow-xl space-y-6">
            ...
            <div
              className={`p-6 rounded-2xl border transition-all ${
                isProfitable
                  ? 'bg-gradient-to-br from-emerald-50 via-white to-slate-50 dark:from-emerald-950/80 dark:via-slate-900 dark:to-slate-950 border-emerald-300 dark:border-emerald-500/50 shadow-md dark:shadow-xl'
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mt-4 pt-4 border-t border-slate-200 dark:border-slate-800/80">
                <div>
                  <span className="text-[10.5px] uppercase font-bold text-slate-500 dark:text-slate-400 block">
                    {t.dossier.netROI}
                  </span>
                  <span
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between items-center p-3 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
                ...
                {/* Total All-in */}
                <div className="flex justify-between items-center p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800/60 mt-3 shadow-sm">
