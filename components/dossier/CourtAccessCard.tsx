...
export function CourtAccessCard({
  ...
  return (
    <div className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900/90 p-6 sm:p-7 text-slate-800 dark:text-slate-100 shadow-md dark:shadow-xl relative overflow-hidden space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 relative z-10">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <div className="p-2 rounded-xl bg-sky-50 dark:bg-sky-500/10 border border-sky-200 dark:border-sky-500/30 text-sky-600 dark:text-sky-400">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {courtName} • <span className="font-mono text-emerald-600 dark:text-emerald-400 font-bold">Exp: {expediente}</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className="px-3 py-1 text-xs rounded-xl bg-sky-50 text-sky-800 border border-sky-200 dark:bg-sky-500/10 dark:text-sky-300 dark:border-sky-500/30 font-mono font-bold whitespace-nowrap">
            {isEn ? 'Public Record (Art. 8.1 CPC)' : 'Acceso Público (Art. 8.1 CPC)'}
          </span>
          <span className="px-2.5 py-1 text-[11px] rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 font-mono">
            {recipientEmail}
          </span>
        </div>
      </div>
      ...
      {/* Explanatory Body */}
      <div className="relative z-10 text-xs sm:text-sm text-slate-700 dark:text-slate-300 leading-relaxed bg-slate-50 dark:bg-slate-950/60 p-4 rounded-2xl border border-slate-200 dark:border-slate-800/80 space-y-1.5">
        <p>
          {isEn
      ...
      <div className="flex flex-wrap items-center gap-3 relative z-10">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-sky-600 to-cyan-500 hover:from-sky-500 hover:to-cyan-400 text-white text-xs sm:text-sm font-black shadow-md shadow-sky-600/20 dark:shadow-sky-950/50 transition-all hover:scale-[1.02] active:scale-95"
        >
        ...
        <button
          type="button"
          onClick={handleCopy}
          className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all border shadow-sm ${
            copied
              ...
              : 'bg-white hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 border-slate-300 dark:border-slate-700 hover:text-slate-900 dark:hover:text-white'
          }`}
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-950 dark:hover:bg-slate-800 text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-200 text-xs font-semibold border border-slate-200 dark:border-slate-800 transition-all"
        >
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 hover:border-slate-400 dark:hover:border-slate-600 bg-white hover:bg-slate-50 dark:bg-slate-950 dark:hover:bg-slate-900 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white text-xs sm:text-sm font-semibold transition-all ml-auto group shadow-sm"
        >
          ...
          <ExternalLink className="w-3.5 h-3.5 text-slate-400 group-hover:text-sky-600 dark:group-hover:text-sky-400" />
        </a>
      </div>
      ...
      {showPreview && (
        <div className="relative z-10 pt-2 animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="p-4 bg-slate-50 dark:bg-slate-950 rounded-2xl border border-slate-200 dark:border-slate-800 font-mono text-xs text-slate-800 dark:text-slate-300 whitespace-pre-wrap leading-relaxed select-all">
            <div className="pb-2 mb-2 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between text-slate-500 dark:text-slate-400 font-sans text-[11px]">
